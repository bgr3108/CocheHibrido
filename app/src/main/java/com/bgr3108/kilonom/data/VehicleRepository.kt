...
/**
 * Keeps the one-vehicle API used by the current UI while persisting a Room-backed active vehicle.
 * The rest of the app still reads all fuel entries temporarily; phase 2 will scope those reads by
 * [activeVehicleId].
 */
